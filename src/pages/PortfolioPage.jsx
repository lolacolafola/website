...
const portfolioItems = [
  {
    ...
    description:
      '14-slide bilingual (EN/FR) deck with revenue simulator. Designed in Figma, built with Claude Code.',
  ...
  },
  {
    ...
    description:
      'Full creative production \u2014 concept, casting, scripting, post-production. A Mint Mobile parody with fake Hugh Jackman, spoof blog, and CEO reveal.',
  ...
  },
  {
    ...
    description:
      'Dark-theme portfolio with WebGL shaders. React 19 + Vite + Claude Code.',
  ...
  },
  {
    ...
    description:
      'E3 2019 stage (10M+ viewers), conferences, panels, live events. Official Ubisoft spokesperson.',
    ...
    <main>
      <section className="portfolio-hero">
        <div className="container">
          ...
          <p className="section-intro">
            The work behind the work &mdash; campaigns, tools, and things I&apos;ve built.
          </p>
        </div>
      </section>
                ...
                <>
                  <div className="portfolio-card-image">
                    {item.image ? (
                      ...
                      <span className="portfolio-card-placeholder">{item.title.split(' \u2014 ')[0]}</span>
                    )}
                  </div>
      ...
      <section className="final-cta">
        <div className="container">
          ...
          <p>
            Let&apos;s talk about your next fan-powered project.
          </p>
